...
def sent_analyzer():
    ...
    if label is None:
        return "Entrada Invalida"
         ...
         return "O texto fornecido foi identificado como {} com um score de {}.".format(label.split('_')[1], score)
    # Retorna uma string formatada com o rótulo e a pontuação do sentimento
